...
const Footer = () => {
    ...
    emailjs.sendForm('service_56kt398', 'template_1bzlg78', form.current, 'XwXQt66PA2MD0KnKF')
      .then((result) => {
                ...
                <div className="title">Let's Work Together!</div>
                     <form ref={form} onSubmit={sendEmail}>
                        <div className='input-container ic1'>
                            <input required onSubmit="return validateForm()" className='input' placeholder='Name' type='text' name="from_name"/>    
                        </div>
                        <div className='input-container ic2'>
                            <input required className='input' placeholder='Email Address' type='email' name="reply_to"/>    
                        </div> 
                        <div className='input-container ic2'>
                            <input required className='input' placeholder='Subject' type='text' name="subject"/>    
                        </div> 
                        <div className='message-container'>
                            <textarea className='input-message' required placeholder='Message' name="message" />    
                        </div> 
